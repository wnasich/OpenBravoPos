...
set CP=%CP%;"%DIRNAME%lib/ifepson.jar"
set CP=%CP%;"%DIRNAME%lib/log4j-1.2.16.jar"
...
start /B javaw -cp %CP% -Djava.util.logging.config.file="%DIRNAME%logging.properties" -Djava.library.path="%DIRNAME%lib/Windows/i368-mingw32" -Ddirname.path="%DIRNAME%./" -Dlog4j.configuration="file:/%DIRNAME%openbravopos-log4j.properties" com.openbravo.pos.forms.StartPOS %1
