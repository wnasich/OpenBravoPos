...
import com.openbravo.pos.printer.fiscal.DevicePrinterFiscalEpson;
...
public class DeviceTicket {
    ...
    public DeviceTicket(Component parent, AppProperties props) {
        ...
        try {
            ...
            } else if ("fiscal-afip-epson".equals(sFiscalType)) {
                m_deviceFiscal = new DevicePrinterFiscalEpson(sFiscalParam1);
            } else {
                m_deviceFiscal = new DeviceFiscalPrinterNull();
            }
